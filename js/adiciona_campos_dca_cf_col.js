...
cont++;
        $('#dcaadicionais').append('<div class="row" id="dcaAdd' + cont + '"> <div class="col-lg-4 col-md-4 col-12"> <div class="form-floating mb-3"> <input type="text" name="dca_nome[]" class="form-control" id="dca_nome" placeholder="Nome"> <label for="dca_nome">Nome</label> </div></div><div class="col-lg-4 col-md-4 col-12"> <div class="form-floating mb-3"> <input type="text" name="dca_cargo[]" class="form-control" id="dca_cargo" placeholder="Cargo"> <label for="dca_cargo">Cargo</label> </div></div><div class="col-lg-4 col-md-4 col-12"> <div class="form-floating mb-3"> <input type="date" name="dca_mandato[]" class="form-control" id="dca_mandato" placeholder="Mandato"> <label for="dca_mandato">Mandato</label> </div></div><div class="col-lg-4 col-md-4 col-12"> <div class="form-floating mb-3"> <input type="text" name="dca_telefone[]" class="form-control" id="dca_telefone" placeholder="Telefone"> <label for="dca_telefone">Telefone</label> </div></div><div class="col-lg-7 col-md-7 col-12"> <div class="form-floating mb-3"> <input type="email" name="dca_email" class="form-control" id="dca_email[]" placeholder="E-mail"> <label for="dca_email">E-mail</label> </div></div><div class="col-lg-1 col-md-1 col-12"><br><button type="button" id="' + cont + '" class="btn btn-danger btn-apagar"><i class="uil uil-minus-square"></i></button></div></div>');
});
