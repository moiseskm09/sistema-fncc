...
$queryAtualizaDadosPrincipais = "UPDATE cooperativas SET coop_razao = '$coop_razao', cooperativa = '$coop_fantasia' WHERE cod_coop = '$cooperativa'";
...
if (isset($_POST["dca_nomeN"], $_POST["dca_cargoN"], $_POST["dca_telefoneN"], $_POST["dca_emailN"])) {
    ...
    function dcan($dca_nomeN, $dca_cargoN, $dca_mandatoN, $dca_telefoneN, $dca_emailN, $coopArray) {
        //global $cooperativa;
        return "('{$dca_nomeN}', '{$dca_cargoN}', '{$dca_mandatoN}', '{$dca_telefoneN}', '{$dca_emailN}', '{$coopArray}')";
    }

    $dadosN = array_map("dcan", $dca_nomeN, $dca_cargoN, $dca_telefoneN, $dca_emailN, $dca_mandatoN, $coopArray);
...
if (isset($_POST["cf_nomeN"], $_POST["cf_cargoN"], $_POST["cf_telefoneN"], $_POST["cf_emailN"])) {
    ...
    function cfn($cf_nomeN, $cf_cargoN, $cf_mandatoN, $cf_telefoneN, $cf_emailN, $coopArray) {
        //global $cooperativa;
        return "('{$cf_nomeN}', '{$cf_cargoN}', '{$cf_mandatoN}', '{$cf_telefoneN}', '{$cf_emailN}', '{$coopArray}')";
    }

    $dadosCFN = array_map("cfn", $cf_nomeN, $cf_cargoN, $cf_telefoneN, $cf_emailN, $cf_mandatoN, $coopArray);
...
if (isset($_POST["col_nomeN"], $_POST["col_areaN"], $_POST["col_emailN"])) {
    ...
    function colN($col_nomeN, $col_areaN, $col_emailN, $coopArray) {
        return "('{$col_nomeN}','{$col_areaN}', '{$col_emailN}', '{$coopArray}')";
    }

    $dadosColN = array_map("colN", $col_nomeN, $col_areaN, $col_emailN, $coopArray);
