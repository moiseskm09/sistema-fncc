...
$senhaLogin = md5($_POST['senha']);   
    ...
    $sqlUsuario = mysqli_query($conexao, "SELECT id_usuario, email, senha, nome, sobrenome, user_nivel, logo_coop, user_coop, user_grupo, user_supervisor FROM usuarios INNER JOIN cooperativas on user_coop = cod_coop WHERE usuario = '$emailLogin' and senha = '$senhaLogin' and u_status = '1' LIMIT 1");
   ...
   // echo "usuario";
	...
	$_SESSION['nome']=$resultadoUsuario['nome'];
        ...
        $_SESSION['user_supervisor']=$resultadoUsuario['user_supervisor'];
