...
$sqlAtualizaInformacoes  = mysqli_query($conexao, "UPDATE usuarios SET nome = '$nome', sobrenome = '$sobrenome', email = '$email', user_nivel = '$nivel', user_coop = '$cooperativa', usuario = '$usuario' WHERE id_usuario = '$idUsuario'");
