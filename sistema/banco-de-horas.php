                                                    ...
                                                    if (mysqli_num_rows($buscaPonto) > 0) {
                                                        while ($resultadoPonto = mysqli_fetch_assoc($buscaPonto)) {
                                                            ...
                                                            <tr class="linha-hover info-td">
                                                                <td class="info-td">
                                                                    <?php
                                                                    if($resultadoPonto["ponto_hora_atraso"] != null && $resultadoPonto["ponto_hora_extra"] == null || $resultadoPonto["ponto_hora_atraso"] != "00:00:00" && $resultadoPonto["ponto_hora_extra"] == "00:00:00"){
                                                                        echo '<i title="Atraso" class="btn btn-sm btn-outline-danger rounded bi bi-exclamation-circle"></i>'; 
                                                                    }elseif($resultadoPonto["ponto_hora_atraso"] == null && $resultadoPonto["ponto_hora_extra"] != null || $resultadoPonto["ponto_hora_atraso"] == "00:00:00" && $resultadoPonto["ponto_hora_extra"] != "00:00:00"){
