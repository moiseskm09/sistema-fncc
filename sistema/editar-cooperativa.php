                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-12">
                                                        <div class="form-floating mb-3">
                                                            <input type="text" name="coop_endereco" class="form-control" id="endereco" placeholder="Endereço" value="<?php echo $resultadoBuscaInfo["coop_endereco"]; ?>" disabled>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-12">
                                                        <div class="form-floating mb-3">
                                                            <input type="text" name="coop_bairro" class="form-control" id="bairro" placeholder="Bairro" value="<?php echo $resultadoBuscaInfo["coop_bairro"]; ?>" disabled>
                                                            <label for="coop_bairro">Bairro</label>
                                                        </div>  
                                                    </div>
                                                    <div class="col-lg-4 col-md-4 col-12">
                                                        <div class="form-floating mb-3">
                                                            <input type="text" name="coop_cidade" class="form-control" id="cidade" placeholder="Cidade" value="<?php echo $resultadoBuscaInfo["coop_cidade"]; ?>" disabled>
                                                            <label for="coop_cidade">Cidade</label>
                                                        </div>  
                                                    </div>
                                                    <div class="col-lg-2 col-md-2 col-12">
                                                        <div class="form-floating mb-3">
                                                            <input type="text" name="coop_estado" class="form-control" id="estado" placeholder="Estado" value="<?php echo $resultadoBuscaInfo["coop_estado"]; ?>" disabled>
                                            ...
                                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row mt-2 mb-2">
                                                        ...
                                                        <div class="col-lg-1 col-md-1 col-12 g-2 align-items-center">
                                                            <a href="../ferramentas/deleta_dcacfcol.php?cf=<?php echo $resultadoCF["cf_id"];?>&id=<?php echo $cooperativa;?>" class="btn btn-md btn-danger"><i class="uil uil-trash-alt"></i></a>
                                                        </div>
                                                    </div>
                                                    <?php 
                                                    }
                                            ...
                                            <div id="collapseFor" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-1 col-md-1 col-12 g-2 align-items-center">
                                                            <a href="../ferramentas/deleta_dcacfcol.php?col=<?php echo $resultadoCOL["cod_col"];?>&id=<?php echo $cooperativa;?>" class="btn btn-md btn-danger"><i class="uil uil-trash-alt"></i></a>
                                                        </div>
                                                    </div>
                                                    <?php 
                                                    }
