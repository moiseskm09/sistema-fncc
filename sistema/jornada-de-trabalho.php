                                                    ...
                                                    if (mysqli_num_rows($buscaJornada) > 0) {
                                                        while ($resultadoJornada = mysqli_fetch_assoc($buscaJornada)) {
                                                            ...
                                                            <tr class="linha-hover info-td" <?php if ($resultadoJornada["cod_jornada"] == 6 || $resultadoJornada["cod_jornada"] == 7){ echo 'style="background-color: #FFD70F89;"';}?> >
                                                                ...
                                                                <td class="info-td text-success fw-bold"><input type="time" name="entrada[]" class="form-control" value="<?php if($resultadoJornada["jor_entrada"] == null){}else{ echo strftime('%H:%M', strtotime($resultadoJornada["jor_entrada"]));} ?>"></td>
                                                                <td class="info-td text-success fw-bold"><input type="time" name="intervalo[]" class="form-control" value="<?php if($resultadoJornada["jor_intervalo"] == null){}else{ echo strftime('%H:%M', strtotime($resultadoJornada["jor_intervalo"]));}?>"></td>
                                                                <td class="info-td text-success fw-bold"><input type="time" name="fim_intervalo[]" class="form-control" value="<?php if($resultadoJornada["jor_fim_intervalo"] == null){}else{ echo strftime('%H:%M', strtotime($resultadoJornada["jor_fim_intervalo"]));} ?>"></td>
                                                                <td class="info-td text-success fw-bold"><input type="time" name="saida[]" class="form-control" value="<?php if($resultadoJornada["jor_saida"] == null){}else{ echo strftime('%H:%M', strtotime($resultadoJornada["jor_saida"]));} ?>"></td>
                                                                <td class="info-td text-success fw-bold"><input type="time" name="tolerancia[]" class="form-control" value="<?php if($resultadoJornada["jor_tolerancia"] == null){}else{ echo strftime('%H:%M', strtotime($resultadoJornada["jor_tolerancia"]));} ?>"></td>
                                                            </tr>
                                                            <?php
                                                        }
                                                    } else {
