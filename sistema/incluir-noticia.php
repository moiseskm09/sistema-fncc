                                            ...
                                            <div class="accordion" id="DadosNoticia">
                                                <div class="accordion-item">
                                                    ...
                                                    <div class="form-floating mb-2">
                                                        <input type="text" name="tituloNoticia" id="tituloNoticia" class="form-control" placeholder="Título da Notícia" autocomplete="off" maxlength="150" required>
                                                        <label for="tituloNoticia">Título da Notícia <span class="text-danger">*</span></label>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-floating mb-2">
                                                        <input type="text" name="subtituloNoticia" id="subtituloNoticia" class="form-control" placeholder="Subtítulo da Notícia" autocomplete="off" maxlength="200">
